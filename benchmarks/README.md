...
that one cell per row is selected. This synthetic interaction measures rendering
work; it is not a keyboard, pointer latency, scrolling, or accessibility audit.
